export function PrivacyPolicy({ onBack }) {
  return (
    <div className="min-h-screen bg-gray-900 text-gray-300">
      ...
      <header className="bg-gray-800 border-b border-gray-700 py-4 px-6 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <span className="text-white font-semibold text-lg">Keel</span>
          </div>
          <button
            onClick={onBack}
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-8">
          ...
          <section>
            ...
            <h3 className="text-xl font-medium text-white mt-6 mb-3">2.2 Financial Data</h3>
            <p>When you connect your bank accounts through our third-party provider Plaid, we may access:</p>
            ...
            <p className="mt-3">
              <strong className="text-white">Important:</strong> We never store your bank login credentials. 
              Authentication is handled securely by Plaid.
            </p>

            <h3 className="text-xl font-medium text-white mt-6 mb-3">2.3 Usage Data</h3>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li><strong className="text-white">Encryption in Transit:</strong> All data is transmitted using TLS 1.2 or higher</li>
              <li><strong className="text-white">Encryption at Rest:</strong> All stored data is encrypted using AES-256</li>
              <li><strong className="text-white">Cloud Infrastructure:</strong> Data is stored on Google Cloud Platform (Firebase) with SOC 2 Type II certification</li>
              <li><strong className="text-white">Access Controls:</strong> Strict authentication and authorization controls</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              <li><strong className="text-white">Plaid:</strong> For secure bank account connections. See <a href="https://plaid.com/legal" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300">Plaid's Privacy Policy</a></li>
              <li><strong className="text-white">Stripe:</strong> For payment processing. See <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300">Stripe's Privacy Policy</a></li>
              <li><strong className="text-white">Firebase/Google Cloud:</strong> For data storage and authentication. See <a href="https://firebase.google.com/support/privacy" target="_blank" rel="noopener noreferrer" className="text-purple-400 hover:text-purple-300">Firebase Privacy</a></li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 mt-3">
              ...
              <li><strong className="text-white">Disconnect:</strong> Revoke access to connected bank accounts at any time</li>
            </ul>
            <p className="mt-3">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-white mb-4">11. California Residents (CCPA)</h2>
            <p>
      ...
      {/* Footer */}
      <footer className="py-8 px-6 bg-gray-800 border-t border-gray-700 mt-12">
