...
export function Auth({ auth, onAuthSuccess, onBackToLanding, initialIsSignUp = false }) {
      ...
      <div className="min-h-screen bg-white flex items-center justify-center p-4">
        <div className="w-full max-w-md">
          <div className="bg-white p-10 rounded-3xl shadow-2xl border-2 border-gray-200">
            <img src="/keel-logo.png" alt="Keel" className="w-20 h-20 mx-auto mb-6" />
            <h2 className="text-center text-2xl font-bold text-[#0a2540] mb-2">Reset Password</h2>
            ...
            <form onSubmit={handleForgotPassword} className="space-y-5">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-white border-2 border-gray-200 rounded-xl text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-[#635bff] focus:border-transparent"
                  required
                />
              </div>

              {error && <div className="p-4 bg-red-50 border border-red-200 rounded-xl text-red-600 text-sm">{error}</div>}
              {success && <div className="p-4 bg-green-50 border border-green-200 rounded-xl text-green-600 text-sm">{success}</div>}

              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#635bff] hover:bg-[#5851ea] disabled:bg-gray-300 text-white font-semibold rounded-xl transition-colors cursor-pointer"
              >
            ...
            <div className="mt-6 text-center">
              <button
                ...
                className="text-[#635bff] hover:text-[#5851ea] font-medium cursor-pointer"
              >
                ← Back to Sign In
              </button>
            </div>
  ...
  return (
    <div className="min-h-screen bg-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="bg-white p-10 rounded-3xl shadow-2xl border-2 border-gray-200">
          <img src="/keel-logo.png" alt="Keel" className="w-24 h-24 mx-auto mb-8" />

          {isSignUp ? (
            <>
              <h2 className="text-center text-3xl font-bold text-[#0a2540] mb-3">Sign up for Keel</h2>
              <p className="text-center text-gray-600 mb-8">Start your 7-day free trial</p>
            </>
          ) : (
            <>
              <h2 className="text-center text-3xl font-bold text-[#0a2540] mb-3">Welcome back</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              ...
              disabled={loading}
              className="w-full py-3.5 bg-white hover:bg-gray-50 disabled:bg-gray-100 text-gray-700 font-semibold rounded-xl transition-colors cursor-pointer flex items-center justify-center gap-3 border-2 border-gray-300"
            >
            ...
            <div>
              <label className="block text-sm font-medium text-[#0a2540] mb-2">Password</label>
              <input
                type="password"
                value={password}
            ...
            {isSignUp && (
              <div className="flex items-start gap-3 pt-2">
                <input
                  ...
                  className="mt-1 w-4 h-4 text-[#635bff] border-gray-300 rounded focus:ring-[#635bff] cursor-pointer"
                />
                <label htmlFor="terms" className="text-sm text-gray-600 leading-relaxed cursor-pointer">
                  I agree to the{' '}
                  <a href="#" onClick={(e) => { e.preventDefault(); window.open('/terms', '_blank') }} className="text-[#635bff] hover:text-[#5851ea] font-medium">
                    Terms of Service
                  </a>
                  {' '}and{' '}
                  <a href="#" onClick={(e) => { e.preventDefault(); window.open('/privacy', '_blank') }} className="text-[#635bff] hover:text-[#5851ea] font-medium">
                    Privacy Policy
                  </a>
                </label>
              </div>
                ...
                {showResendVerification && (
                  <div className="mt-3 pt-3 border-t border-red-200">
                    ...
                    <button
                      ...
                      className="text-xs bg-red-100 hover:bg-red-200 px-3 py-2 rounded-lg font-medium transition-colors cursor-pointer disabled:opacity-50"
                    >
          ...
          {!isSignUp && (
            <div className="mt-5 text-center">
              <button
                ...
                className="text-[#635bff] hover:text-[#5851ea] text-sm font-medium cursor-pointer"
              >
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600 text-sm">
              ...
              <button
                ...
                className="text-[#635bff] hover:text-[#5851ea] font-semibold cursor-pointer"
              >
          ...
          {onBackToLanding && (
            <div className="mt-6 text-center">
              <button
                ...
                className="text-gray-500 hover:text-[#0a2540] text-sm transition-colors cursor-pointer"
              >
                ← Back to Home
              </button>
            </div>
